    ...
    <>
      ...
      <section className="container py-xl" style={{ flex: 1, position: 'relative' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', marginBottom: '4rem' }}>
          ...
          <div className="animate-on-scroll" style={{ borderRadius: 'var(--radius-md)', overflow: 'hidden', boxShadow: 'var(--shadow-sm)', aspectRatio: '16/9', position: 'relative', background: 'var(--clr-surface)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            {team.image ? (
